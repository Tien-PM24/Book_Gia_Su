...
<html>
  ...
  <body>
    ...
    $sql="SELECT * FROM teacher,picture_teacher where teacher.ID_teacher='$id' and picture_teacher.ID_teacher ='$id'";
    ...
    <div class="main-block">
      ...
      <form action="/">
        ...
        <input type="text" name="name" id="name" value="<?php echo $row['Password']?>"/>
        <hr>
        <hr>
        <div>
        <img src="../../../../Asset/Picture/Teacher/Teacher-4.png" alt="">
        <input type="file" name="Chose file">
        </div>
        <div class="btn-block">
