...
<script>
  var Class=document.querySelector(".itemOder")
  Class.style.borderBottom="1px soild red"
</script>
<!-- <!doctype html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <script>
      var colorClass=document.querySelector('.itemOder');
      colorClass.style.borderBottom="1px soild red";
    </script>
