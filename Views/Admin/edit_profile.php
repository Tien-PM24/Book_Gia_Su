...
<head>
    ...
    <link rel="stylesheet" href="../../Public/Styles/Admin/edit_profile.css">
    <title>Profile</title>
</head>
<body>
        ...
        <div class="fui-card-profile-1">
            ...
            <?php
                ...
                <div class="card-button-wrap">
                   <a href="./execute_profile.php?edit=<?php echo $avatar['id_admin']?>"><button class="card-btn card-btn--secondary">
                        Edit
                    </button></a> 
