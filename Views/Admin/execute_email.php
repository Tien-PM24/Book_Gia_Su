<?php
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'hovandideveloper@gmail.com';
    $mail->Password = 'ckmfrvdobdwnebtc';
    $mail->SMTPSecure = 'tls';  // Loại mã hóa SSL hoặc TLS
    $mail->Port = 587;  // Cổng SMTP
    
    // Thiết lập thông tin email
    $mail->setFrom('hovandideveloper@gmail.com', 'King Dom');  // Địa chỉ email gửi đi và tên người gửi
